...
cp "$VALHEIM_INSTALL/valheim_Data/Managed/Splatform.dll" "$ModNameUnity/Assets/Assemblies"
cp "$VALHEIM_INSTALL/valheim_Data/Managed/Splatform.Steam.dll" "$ModNameUnity/Assets/Assemblies"
